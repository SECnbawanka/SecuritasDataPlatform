...
CREATE OR REPLACE SCHEMA MYSECURITAS;


CREATE OR REPLACE VIEW GRSNO_ALARM AS
SELECT ALARM_ID,
ALARM_NO,
ALARM_GROUP_ID,
ALARM_TYPE_ID,
...
alter view GRSNO_ALARM set secure;

CREATE OR REPLACE VIEW GRSNO_ALARM_CODES AS 
...
alter view GRSNO_ALARM_CODES set secure;

CREATE OR REPLACE VIEW GRSNO_ALARM_GROUP AS 
...
alter view GRSNO_ALARM_GROUP set secure;

CREATE OR REPLACE VIEW GRSNO_ASSIGNMENT_TYPE AS 
...
alter view GRSNO_ASSIGNMENT_TYPE set secure;

CREATE OR REPLACE VIEW GRSNO_COMMITMENT AS
...
alter view GRSNO_COMMITMENT set secure;

CREATE OR REPLACE VIEW GRSNO_COMMIT_LOC_OBJECT AS
...
alter view GRSNO_COMMIT_LOC_OBJECT set secure;

CREATE OR REPLACE VIEW GRSNO_CONTRACT AS 
...
FROM ODS_GRS_NO.DBO.CONTRACT,
  DW.CONTROL.KEY_STORE KS
WHERE  ARRAYS_OVERLAP(ARRAY_CONSTRUCT(ODS_SRC_SYSTEM_ID),SOURCESYSTEMID) =TRUE;
alter view GRSNO_CONTRACT set secure;

CREATE OR REPLACE VIEW GRSNO_CONTRACT_PART AS 
...
alter view GRSNO_CONTRACT_PART set secure;

CREATE OR REPLACE VIEW GRSNO_CONTRACT_TYPE AS 
...
alter view GRSNO_CONTRACT_TYPE set secure;

CREATE OR REPLACE VIEW GRSNO_CONTR_PART_VER AS 
...
DW.CONTROL.KEY_STORE KS
WHERE  ARRAYS_OVERLAP(ARRAY_CONSTRUCT(ODS_SRC_SYSTEM_ID),SOURCESYSTEMID) =TRUE;
alter view GRSNO_CONTR_PART_VER set secure;

CREATE OR REPLACE VIEW GRSNO_CUSTOMER AS 
...
FROM ODS_GRS_NO.DBO.CUSTOMER,
  DW.CONTROL.KEY_STORE KS
WHERE  ARRAYS_OVERLAP(ARRAY_CONSTRUCT(ODS_SRC_SYSTEM_ID),SOURCESYSTEMID) =TRUE;
alter view GRSNO_CUSTOMER set secure;

CREATE OR REPLACE VIEW GRSNO_CUSTOMER_OBJECT AS 
...
FROM ODS_GRS_NO.DBO.CUSTOMER_OBJECT,
  DW.CONTROL.KEY_STORE KS
WHERE  ARRAYS_OVERLAP(ARRAY_CONSTRUCT(ODS_SRC_SYSTEM_ID),SOURCESYSTEMID) =TRUE;
alter view GRSNO_CUSTOMER_OBJECT set secure;

CREATE OR REPLACE VIEW GRSNO_CUST_CUST_OBJECT AS 
...
alter view GRSNO_CUST_CUST_OBJECT set secure;

CREATE OR REPLACE VIEW GRSNO_GCS_EXPORT_ERP_CALL_OUTS AS
SELECT CASE_NUMBER,
ALARM_NUMBER,
ALARM_CENTER_NAME,
...
FROM ODS_GRS_NO.DBO.GCS_EXPORT_ERP_CALL_OUTS,
  DW.CONTROL.KEY_STORE KS
WHERE  ARRAYS_OVERLAP(ARRAY_CONSTRUCT(ODS_SRC_SYSTEM_ID),SOURCESYSTEMID) =TRUE;
alter view GRSNO_GCS_EXPORT_ERP_CALL_OUTS set secure;

CREATE OR REPLACE VIEW GRSNO_GCS_EXPORT_ERP_CALL_OUT_GUARDS AS 
...
DW.CONTROL.KEY_STORE KS
WHERE  ARRAYS_OVERLAP(ARRAY_CONSTRUCT(ODS_SRC_SYSTEM_ID),SOURCESYSTEMID) =TRUE;
alter view GRSNO_GCS_EXPORT_ERP_CALL_OUT_GUARDS set secure;

CREATE OR REPLACE VIEW GRSNO_GD AS 
...
DW.CONTROL.KEY_STORE KS
WHERE  ARRAYS_OVERLAP(ARRAY_CONSTRUCT(ODS_SRC_SYSTEM_ID),SOURCESYSTEMID) =TRUE;
alter view GRSNO_GD set secure;

CREATE OR REPLACE VIEW GRSNO_GRS_ADDONINFO AS 
...
FROM ODS_GRS_NO.DBO.GRS_ADDONINFO,
  DW.CONTROL.KEY_STORE KS
WHERE  ARRAYS_OVERLAP(ARRAY_CONSTRUCT(ODS_SRC_SYSTEM_ID),SOURCESYSTEMID) =TRUE;
alter view GRSNO_GRS_ADDONINFO set secure;

CREATE OR REPLACE VIEW GRSNO_LOCATION_MARK AS 
...
FROM ODS_GRS_NO.DBO.LOCATION_MARK,
  DW.CONTROL.KEY_STORE KS
WHERE  ARRAYS_OVERLAP(ARRAY_CONSTRUCT(ODS_SRC_SYSTEM_ID),SOURCESYSTEMID) =TRUE;
alter view GRSNO_LOCATION_MARK set secure;

CREATE OR REPLACE VIEW GRSNO_LOCATION_OBJECT AS 
...
alter view GRSNO_LOCATION_OBJECT set secure;

CREATE OR REPLACE VIEW GRSNO_LOC_MARK_REPORT AS 
...
alter view GRSNO_LOC_MARK_REPORT set secure;

CREATE OR REPLACE VIEW GRSNO_LOC_MARK_TYPE AS
...
alter view GRSNO_LOC_MARK_TYPE set secure;

CREATE OR REPLACE VIEW GRSNO_PROCESSED_TRANSACTIONS AS 
...
FROM ODS_GRS_NO.DBO.PROCESSED_TRANSACTIONS,
  DW.CONTROL.KEY_STORE KS
WHERE  ARRAYS_OVERLAP(ARRAY_CONSTRUCT(ODS_SRC_SYSTEM_ID),SOURCESYSTEMID) =TRUE;
alter view GRSNO_PROCESSED_TRANSACTIONS set secure;

CREATE OR REPLACE VIEW GRSNO_PRODUCTION_OBJECT AS 
...
FROM ODS_GRS_NO.DBO.PRODUCTION_OBJECT,
  DW.CONTROL.KEY_STORE KS
WHERE  ARRAYS_OVERLAP(ARRAY_CONSTRUCT(ODS_SRC_SYSTEM_ID),SOURCESYSTEMID) =TRUE;
alter view GRSNO_PRODUCTION_OBJECT set secure;

CREATE OR REPLACE VIEW GRSNO_PROD_CUST_OBJECT AS
...
alter view GRSNO_PROD_CUST_OBJECT set secure;

CREATE OR REPLACE VIEW GRSNO_PROFITCENTER AS 
...
DW.CONTROL.KEY_STORE KS
WHERE  ARRAYS_OVERLAP(ARRAY_CONSTRUCT(ODS_SRC_SYSTEM_ID),SOURCESYSTEMID) =TRUE;
alter view GRSNO_PROFITCENTER set secure;

CREATE OR REPLACE VIEW GRSNO_REPORT_MARK AS 
...
alter view GRSNO_REPORT_MARK set secure;

CREATE OR REPLACE VIEW GRSNO_REPORT_MARK_CULTURE AS 
...
alter view GRSNO_REPORT_MARK_CULTURE set secure;

CREATE OR REPLACE VIEW GRSNO_SFU_COMMITMENTPERFORMED AS
...
alter view GRSNO_SFU_COMMITMENTPERFORMED set secure;

CREATE OR REPLACE VIEW GRSNO_SFU_COMMITMENTPERFORMEDEXTRAVISITS AS
...
alter view GRSNO_SFU_COMMITMENTPERFORMEDEXTRAVISITS set secure;

CREATE OR REPLACE VIEW GRSNO_TEMP_TRANSACTIONS AS 
...
DW.CONTROL.KEY_STORE KS
WHERE  ARRAYS_OVERLAP(ARRAY_CONSTRUCT(ODS_SRC_SYSTEM_ID),SOURCESYSTEMID) =TRUE;
alter view GRSNO_TEMP_TRANSACTIONS set secure;

CREATE OR REPLACE VIEW GRSNO_TEMP_TRANSACTIONS_ATTACHMENT AS 
...
DW.CONTROL.KEY_STORE KS
WHERE  ARRAYS_OVERLAP(ARRAY_CONSTRUCT(ODS_SRC_SYSTEM_ID),SOURCESYSTEMID) =TRUE;
alter view GRSNO_TEMP_TRANSACTIONS_ATTACHMENT set secure;

CREATE OR REPLACE VIEW GRSNO_TEMP_TRANSACTIONS_ATTACHMENT_CULTURE AS 
...
DW.CONTROL.KEY_STORE KS
WHERE  ARRAYS_OVERLAP(ARRAY_CONSTRUCT(ODS_SRC_SYSTEM_ID),SOURCESYSTEMID) =TRUE;
alter view GRSNO_TEMP_TRANSACTIONS_ATTACHMENT_CULTURE set secure;

CREATE OR REPLACE VIEW GRSNO_USERS AS 
SELECT USER_ID, 
CASE 
...
DW.CONTROL.KEY_STORE KS 
WHERE  ARRAYS_OVERLAP(ARRAY_CONSTRUCT(ODS_SRC_SYSTEM_ID),SOURCESYSTEMID) =TRUE;
alter view GRSNO_USERS set secure;

CREATE OR REPLACE SECURE VIEW GRSNO_XPROCESSED_BARCODES AS 
...
FROM  ODS_GRS_NO.DBO.PROCESSED_TRANSACTIONS_2020 PT
JOIN 
DW.CONTROL.KEY_STORE KS
...
AND  (BARCODE_TYPE <> 2) OR 
    ...
    (BARCODE_TYPE = 2) AND (
		EXISTS ( -- PRECISERING MEN INGA HSNDELSE, STGSRD ETC
        	SELECT *    
      		FROM ODS_GRS_NO.DBO.PROCESSED_TRANSACTIONS_2020 PT2, ODS_GRS_NO.DBO.REPORT_MARK RM
...
;
alter view GRSNO_XPROCESSED_BARCODES set secure;

CREATE OR REPLACE VIEW GRSNO_XPROCESSED_TRANSACTIONS AS 
...
WHERE  ARRAYS_OVERLAP(ARRAY_CONSTRUCT(PT.ODS_SRC_SYSTEM_ID),SOURCESYSTEMID) =TRUE
;
alter view GRSNO_XPROCESSED_TRANSACTIONS set secure;

CREATE OR REPLACE VIEW GRSNO_XREPORT_MARK AS 

SELECT
	RM.REPORT_MARK_ID
	,RM.REP_MARK_TYPE_ID
	,RM.BARCODE
	,NVL(RMC.REPORT_LABEL,RM.REPORT_LABEL) AS REPORT_LABEL
	,RM.ACTIVITY_CODE
	,RM.TIMELIMIT_CODE
	,RM.INSERT_DATE
	,RM.INSERT_USER
	...
	,RM.SBA
	,NVL(RMC.CULTURE_ID,0) AS CULTURE_ID
...
alter view GRSNO_XREPORT_MARK set secure;

CREATE OR REPLACE VIEW GRSNO_XTEMP_TRANSACTIONS AS 
...
DW.CONTROL.KEY_STORE KS
WHERE  ARRAYS_OVERLAP(ARRAY_CONSTRUCT(ODS_SRC_SYSTEM_ID),SOURCESYSTEMID) =TRUE;
alter view GRSNO_XTEMP_TRANSACTIONS set secure;

CREATE OR REPLACE VIEW GRSNO_XTEMP_TRANSACTIONS_ATTACHMENT AS
...
alter view GRSNO_XTEMP_TRANSACTIONS_ATTACHMENT set secure;
...
CREATE OR REPLACE VIEW GRSNO_GCS_EXPORT_ERP_CALL_OUT_GUARDS_MP AS 
SELECT BASE_LOCATION_NUMBER, COST_CENTRE, ARRIVAL_TIME, DEPARTURE_TIME, ELAPSED_TIME, GUARD_TYPE, CASE_NUMBER, VISIT_DETAIL, INSERT_USER, INSERT_DATE, CHANGE_USER, CHANGE_DATE, ROWID, ON_WAY_TIME, RETURN_TIME_BACK_TO_OFFICE,  
EMPLOYMENT_NUMBER,
ODS_SRC_SYSTEM_ID, ODS_CREATEDBY, ODS_MODIFIEDBY, ODS_MODIFIEDBY_TIMESTAMP, ODS_CREATEDBY_TIMESTAMP
FROM ODS_GRS_NO.DBO.GCS_EXPORT_ERP_CALL_OUT_GUARDS;
...
CREATE OR REPLACE VIEW GRSNO_TEMP_TRANSACTIONS_MP AS 
SELECT LOGG_ID, TRANS_ID, BARCODE_TIME, BARCODE_NO,BARCODE_GROUP, INSERT_DATE,INSERT_USER, CHANGE_DATE,CHANGE_USER,ROWID,
NOTES, 
ADJUSTED_GD_ID,ADJUSTED_EMPLOYEE_ID,MUASSIGNMENT_ID,
REPORT_NOTES, 
...
FROM ODS_GRS_NO.DBO.TEMP_TRANSACTIONS
;
alter view GRSNO_TEMP_TRANSACTIONS_MP set secure;
...
CREATE OR REPLACE VIEW GRSNO_XPROCESSED_BARCODES_MP AS 
SELECT *
FROM  "ODS_GRS_NO"."DBO"."XPROCESSED_BARCODES_SDV";
alter view GRSNO_XPROCESSED_BARCODES_MP set secure;
...
case
  ...
  WHEN is_role_in_session('USECASE_EU_RISKPREDICTION')
