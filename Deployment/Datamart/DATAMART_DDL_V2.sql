...
CREATE OR REPLACE USER "jussi.kempinen" password='********' DEFAULT_ROLE = SISEU_MYSECURITAS Must_Change_Password = FALSE;

CREATE OR REPLACE USER "Alex.bespalko" password='********' DEFAULT_ROLE = SISEU_MYSECURITAS Must_Change_Password = FALSE;
